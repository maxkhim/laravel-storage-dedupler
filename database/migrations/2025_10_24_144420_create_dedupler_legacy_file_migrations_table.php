...
return new class () extends Migration {
    ...
    {
        Schema::create('dedupler_legacy_file_migrations', function (Blueprint $table) {
            $table->integer('id', true);
            $table->string('original_path');
            $table->string('original_filename');
            $table->char('sha1_hash', 40)->index('idx_file_hash');
    ...
    {
        Schema::dropIfExists('dedupler_legacy_file_migrations');
    }
};
